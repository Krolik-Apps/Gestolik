...
<br>
Para mais informações veja a documentação em: <a href="https://raw.githubusercontent.com/Krolik-Apps/Gestolik/main/documentacao.txt" onclick="return ! window.open(this.href);">Documentação Gestolik</a><br>
